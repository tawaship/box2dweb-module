...
declare module "box2dweb" {
        ...
        **/
        export class b2WorldManifold {
            ...
            **/
            public Initialize(
                manifold: b2Manifold,
                xfA: Common.Math.b2Transform,
                radiusA: number,
                xfB: Common.Math.b2Transform,
                radiusB: number): void;
        }
    }
        ...
        export class b2CircleShape extends b2Shape {
            ...
            **/
            public ComputeSubmergedArea(
                normal: Common.Math.b2Vec2,
                offset: number,
                xf: Common.Math.b2Transform,
                c: Common.Math.b2Vec2): number;
            ...
            **/
            public RayCast(
                ...
                transform: Common.Math.b2Transform): boolean;
    ...
    module Collision.Shapes {
        ...
        **/
        export class b2PolygonShape extends b2Shape {
            ...
            **/
            public static AsArray(vertices: Common.Math.b2Vec2[], vertexCount?: number): b2PolygonShape;
            ...
            **/
            public static AsEdge(v1: Common.Math.b2Vec2, b2: Common.Math.b2Vec2): b2PolygonShape;
            ...
            **/
            public static AsOrientedBox(hx: number, hy: number, center?: Common.Math.b2Vec2, angle?: number): b2PolygonShape;
            ...
            * @return Convex polygon shape.
            **/
            public static AsVector(vertices: Common.Math.b2Vec2[], vertexCount?: number): b2PolygonShape;
        ...
        export class b2Shape {
            ...
            **/
            public static TestOverlap(
                shape1: b2Shape,
                transform1: Common.Math.b2Transform,
                shape2: b2Shape,
                transform2: Common.Math.b2Transform): boolean;
    ...
    export { Common, Collision, Dynamics };
}